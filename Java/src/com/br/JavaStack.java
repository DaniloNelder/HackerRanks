...
public class JavaStack {
	 ...
	 * last element that was added.(Wikipedia) A string containing only parentheses
	 * is balanced if the following is true: 1. if it is an empty string 2. if A and
	 * B are correct, AB is correct, 3. if A is correct, (A) and {A} and [A] are
	 * also correct.
	 * 
