...
public class JavaStdinAndStdout {
	 ...
	 * System.out.println("myInt is: " + myInt); The code above creates a Scanner
	 * object named and uses it to read a String and an int. It then closes the
	 * Scanner object because there is no more input to read, and prints to stdout
	 * using System.out.println(String). So, if our input is:
	 * 
	 * Hi 5 Our code will print:
	 * 
	 * myString is: Hi myInt is: 5 Alternatively, you can use the BufferedReader
	 * class.
	 * 
	 * Task In this challenge, you must read integers from stdin and then print them
